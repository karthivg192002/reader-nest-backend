...
namespace iucs.readernest.application.Services
{
    public interface IBillingService
    {
        ...
        /// False for an admission payment-link invoice: the parent hasn't been enrolled (or given a
        /// login) yet, so the "invoice issued" email would be noise before the welcome email.
        /// </param>
