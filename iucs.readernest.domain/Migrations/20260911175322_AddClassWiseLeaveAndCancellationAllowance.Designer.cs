...
namespace iucs.readernest.domain.Migrations
{
    ...
    [Migration("20260911175322_AddClassWiseLeaveAndCancellationAllowance")]
    partial class AddClassWiseLeaveAndCancellationAllowance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Academics.Batch", b =>
                {
                    ...
                    b.Property<int?>("DurationMinutesOverride")
                        .HasColumnType("integer")
                        .HasColumnName("duration_minutes_override");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Academics.CourseCategory", b =>
                {
                    ...
                    b.HasIndex("DepartmentId", "Name")
                        .IsUnique()
                        .HasDatabaseName("ix_course_categories_department_id_name")
                        .HasFilter("\"is_deleted\" = FALSE");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Academics.EnrollmentForm", b =>
                {
                    ...
                    b.HasIndex("DemoBookingId")
                        .IsUnique()
                        .HasDatabaseName("ix_enrollment_forms_demo_booking_id")
                        .HasFilter("\"is_deleted\" = FALSE");
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("ix_enrollment_forms_status");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Admission.DemoBooking", b =>
                {
                    ...
                    b.Property<DateTime?>("ParentJoinedAtUtc")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("parent_joined_at_utc");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Billing.FeeSuspension", b =>
                {
                    ...
                    b.HasIndex("ChildId")
                        .HasDatabaseName("ix_fee_suspensions_child_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Billing.Invoice", b =>
                {
                    ...
                    b.HasIndex("IssuedAtUtc")
                        .HasDatabaseName("ix_invoices_issued_at_utc");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Billing.Subscription", b =>
                {
                    ...
                    b.HasIndex("ChildId", "PackagePlanId")
                        .IsUnique()
                        .HasDatabaseName("ix_subscriptions_child_id_package_plan_id")
                        .HasFilter("\"status\" = 'Active' AND \"is_deleted\" = FALSE");

                    b.HasIndex("Status", "EndDate")
                        .HasDatabaseName("ix_subscriptions_status_end_date");

                    b.HasIndex("Status", "NextBillingAtUtc")
                        .HasDatabaseName("ix_subscriptions_status_next_billing_at_utc");

                    b.ToTable("subscriptions");
                });

            modelBuilder.Entity("iucs.readernest.domain.Entities.Common.ShortLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("short_links");
                });

            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.BulkEmailBlast", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_bulk_email_blasts");

                    b.HasIndex("BatchId")
                        .HasDatabaseName("ix_bulk_email_blasts_batch_id");

                    b.HasIndex("SentByUserId")
                        .HasDatabaseName("ix_bulk_email_blasts_sent_by_user_id");

                    b.ToTable("bulk_email_blasts");
                });
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.BulkEmailRecipient", b =>
                {
                    ...
                    b.Property<Guid>("BulkEmailBlastId")
                        .HasColumnType("uuid")
                        .HasColumnName("bulk_email_blast_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_bulk_email_recipients");

                    b.HasIndex("BulkEmailBlastId")
                        .HasDatabaseName("ix_bulk_email_recipients_bulk_email_blast_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.BulkEmailReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("BulkEmailRecipientId")
                        .HasColumnType("uuid")
                        .HasColumnName("bulk_email_recipient_id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_bulk_email_replies");

                    b.HasIndex("BulkEmailRecipientId")
                        .IsUnique()
                        .HasDatabaseName("ix_bulk_email_replies_bulk_email_recipient_id")
                        .HasFilter("\"is_deleted\" = FALSE");

                    b.HasIndex("ParentUserId")
                        .HasDatabaseName("ix_bulk_email_replies_parent_user_id");

                    b.ToTable("bulk_email_replies");
                });

            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.ChatEscalation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_chat_escalations");

                    b.HasIndex("ResolvedByUserId")
                        .HasDatabaseName("ix_chat_escalations_resolved_by_user_id");

                    b.HasIndex("Status")
                        .HasDatabaseName("ix_chat_escalations_status");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.ChatFaq", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_chat_faqs");

                    b.ToTable("chat_faqs");
                });

            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.ChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("MatchedFaqId")
                        .HasDatabaseName("ix_chat_messages_matched_faq_id");

                    b.HasIndex("UserId", "CreatedAtUtc")
                        .HasDatabaseName("ix_chat_messages_user_id_created_at_utc");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.ProgressReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("ChildId", "PeriodYear", "PeriodMonth")
                        .IsUnique()
                        .HasDatabaseName("ix_progress_reports_child_id_period_year_period_month")
                        .HasFilter("\"is_deleted\" = FALSE");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Payouts.PayoutRate", b =>
                {
                    ...
                    b.HasIndex("TeacherProfileId", "EffectiveFrom")
                        .IsUnique()
                        .HasDatabaseName("ix_payout_rates_teacher_profile_id_effective_from")
                        .HasFilter("\"is_deleted\" = FALSE");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Users.AccessRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("RequestedModules")
                        ...
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("requested_modules");
                    ...
                    b.HasIndex("RequestedByUserId", "Status")
                        .HasDatabaseName("ix_access_requests_requested_by_user_id_status");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Users.PinResetToken", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_pin_reset_tokens");

                    b.HasIndex("Token")
                        .IsUnique()
                        .HasDatabaseName("ix_pin_reset_tokens_token")
                        .HasFilter("\"is_deleted\" = FALSE");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_pin_reset_tokens_user_id");

                    b.ToTable("pin_reset_tokens");
                });
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Academics.EnrollmentForm", b =>
                {
                    ...
                    b.HasOne("iucs.readernest.domain.Entities.Admission.DemoBooking", "DemoBooking")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_enrollment_forms_demo_bookings_demo_booking_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Billing.FeeSuspension", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Users.Child", "Child")
                        ...
                        .HasForeignKey("ChildId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_fee_suspensions_children_child_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.BulkEmailBlast", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Academics.Batch", "Batch")
                        ...
                        .HasForeignKey("BatchId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_bulk_email_blasts_batches_batch_id");

                    b.HasOne("iucs.readernest.domain.Entities.Users.User", "SentByUser")
                        .WithMany()
                        .HasForeignKey("SentByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bulk_email_blasts_users_sent_by_user_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.BulkEmailRecipient", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Communication.BulkEmailBlast", "BulkEmailBlast")
                        .WithMany("Recipients")
                        .HasForeignKey("BulkEmailBlastId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bulk_email_recipients_bulk_email_blasts_bulk_email_blast_id");
                    ...
                    b.HasOne("iucs.readernest.domain.Entities.Users.User", "RecipientUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bulk_email_recipients_users_recipient_user_id");

                    b.Navigation("BulkEmailBlast");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.BulkEmailReply", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Communication.BulkEmailRecipient", "BulkEmailRecipient")
                        .WithOne("Reply")
                        .HasForeignKey("iucs.readernest.domain.Entities.Communication.BulkEmailReply", "BulkEmailRecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bulk_email_replies_bulk_email_recipients_bulk_email_recipie");
                    ...
                    b.HasOne("iucs.readernest.domain.Entities.Users.User", "ParentUser")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_bulk_email_replies_users_parent_user_id");

                    b.Navigation("BulkEmailRecipient");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.ChatEscalation", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Users.User", "ResolvedByUser")
                        .WithMany()
                        .HasForeignKey("ResolvedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_chat_escalations_users_resolved_by_user_id");
                    ...
                    b.HasOne("iucs.readernest.domain.Entities.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_chat_escalations_users_user_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.ChatMessage", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Communication.ChatFaq", "MatchedFaq")
                        .WithMany()
                        .HasForeignKey("MatchedFaqId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_chat_messages_chat_faqs_matched_faq_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Communication.Notification", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Communication.BulkEmailRecipient", "BulkEmailRecipient")
                        .WithMany()
                        .HasForeignKey("BulkEmailRecipientId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_notifications_bulk_email_recipients_bulk_email_recipient_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Users.AccessRequest", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Users.User", "RequestedByUser")
                        .WithMany()
                        .HasForeignKey("RequestedByUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_access_requests_users_requested_by_user_id");
            ...
            modelBuilder.Entity("iucs.readernest.domain.Entities.Users.PinResetToken", b =>
                {
                    b.HasOne("iucs.readernest.domain.Entities.Users.User", "User")
                        ...
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_pin_reset_tokens_users_user_id");
